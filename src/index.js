...
// importing the parkingLot class
...
/**
 * user's interaction via console
 */
...
function processUserCommands (input) {
    ...
    switch (userCommand) {
        ...
        case 'create_parking_floor':
            try{
                totalparkingfloors=parkingLot.createParkingFloor(input);
                console.log('created a parking floors '+ totalparkingfloors + 'floors')
            }
            catch(err){
                console.log(chalk.red.bold(err.message))
        ...
        case 'status':
            ...
            break;
        case 'registration_numbers_of_cars_with_colour':
        ...
        case 'slot_numbers_of_cars_with_colour':
            ...
            break;
        case 'slot_number_of_registration_number':
